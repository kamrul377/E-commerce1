  ...
  return (
    <div>
      {products ? products.map((item) => {
        ...
        return <div key={id} className="cart w-[90%] sm:w-[80%] border-[2px] border-solid border-slate-200 px-10 rounded  py-5 flex gap-4 my-2 odd:border-l-purple-700    items-center bg-white">
